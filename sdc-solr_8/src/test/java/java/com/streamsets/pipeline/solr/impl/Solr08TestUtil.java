...
public class Solr08TestUtil implements SdcSolrTestUtil {
  Solr08ServerUtil solrServer;
  public Solr08TestUtil(String url) throws Exception {
    solrServer = new Solr08ServerUtil(url);
  }
